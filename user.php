...
<title>eBanking</title>
  ...
  <section class="row table-responsive">
    <h1>Customer list</h1> 
        ...
        <table  class="table table-striped table-hover"> 
            ...
            <tr> 
                ...
                <td><button type="button" class="btn btn-dark"><a href="selectedUser.php?id= <?php echo $rows['id'] ;?>"> Transfer</a></button></td> 
    ...
    <footer class="container">
      ...
      <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bank2" viewBox="0 0 16 16">
